...
<?
global $arRegion;global $arTheme;
global $APPLICATION;
global $elfilt;
...
$regionID = ($arRegion ? $arRegion['ID'] : '');?>
	...
	<?if($arParams["AJAX_REQUEST"]=="N" ){?>
		<div class="top_wrapper row margin0 <?=($arParams["SHOW_UNABLE_SKU_PROPS"] != "N" ? "show_un_props" : "unshow_un_props");?>">
			<div id="portfolio_loader" class="catalog_block items block_list">
...
<?}else{?>
	...
	<div class="no_goods catalog_block_view <?=(($elfilt==1) ? 'none' : '')?> <?echo $elfilt;?>">
