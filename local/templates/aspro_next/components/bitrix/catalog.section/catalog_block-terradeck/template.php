	...
	<?}?>
		...
		<?foreach($arResult["ITEMS"] as $arItem){?>
			<div class="item_block col-<?=$col;?> col-md-<?=ceil(12/$col);?> col-sm-<?=ceil(12/round($col / 2))?> col-xs-6">
				<div class="catalog_item_wrapp item catalog-ter">
					...
					<div class="catalog_item main_item_wrapper item_wrap <?=(($_GET['q'])) ? 's' : ''?>" id="<?=$arItemIDs["strMainID"];?>">
						<div>
							...
							<div class="image_wrapper_block row">
								<div class="stickers">
							...
							<div class="item_info <?=$arParams["TYPE_SKU"]?>">
								...
								<?if ($isArticle): ?>
							<div style="color: #d0d0d0;font-size: 8px;position: absolute;top: 0;right: 5px;">
							<?=$isArticle?>				
							</div>
						<?endif;?>
								...
								<?if(!$arItem["OFFERS"] || $arParams['TYPE_SKU'] !== 'TYPE_1'):?>
									<div class="row counter_wrapp <?=($arItem["OFFERS"] && $arParams["TYPE_SKU"] == "TYPE_1" ? 'woffers' : '')?>">
