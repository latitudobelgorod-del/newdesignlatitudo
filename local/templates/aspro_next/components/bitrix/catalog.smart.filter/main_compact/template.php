					...
					<div class="bx_filter_button_box active hidden">
						<div class="bx_filter_block">
							<div class="bx_filter_parameters_box_container clearfix">
								<div class="bx_filter_popup_result right deb8" id="modef" <?if(!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"';?>>
								...
								<div class="bx_filter_popup_result right pull-left deb9" id="modef_mobile" <?if(!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"';?>>
