<?if('Y' == $arParams['USE_FILTER']):?>
	...
	$GLOBALS['preFilterCatalog'] = CNextRegionality::mergeSmartPreFilterWithRegionFilter($GLOBALS['preFilterCatalog'] ?? []);
	\Aspro\Next\CacheableUrl::addSmartFilterNameParam($arParams['FILTER_NAME']);
	?>
