					   ...
					   <div class="">
						<?if($imageSrc):?>
                            <picture class="loaded">		   
							   <img width="280" height="183" src="<?=$imageSrc?>" alt="<?=($bImage ? $arItem['PREVIEW_PICTURE']['ALT'] : $arItem['NAME'])?>" title="<?=($bImage ? $arItem['PREVIEW_PICTURE']['TITLE'] : $arItem['NAME'])?>" style="  display: block;
    width: 100%;
    height: 100%;
    object-fit: cover;" />
                            </picture>
