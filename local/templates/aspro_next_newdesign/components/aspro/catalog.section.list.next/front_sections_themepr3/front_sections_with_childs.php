					...
					<div class="section_item_inner">
						<div class="img">
							...
							<?elseif($arSection['~PICTURE']):?>
								...
								<a href="<?=$arSection['SECTION_PAGE_URL']?>" class="thumb"><img class="lazy"    src="/assets/lazyload/loading.gif" data-original="<?=$img['src']?>" alt="<?=$arSection['NAME']?>" title="<?=$arSection['NAME']?>" /></a>
							<?else:?>
