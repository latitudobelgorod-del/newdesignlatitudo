...
$staff_id = CNextCache::$arIBlocks[SITE_ID]["aspro_next_content"]["aspro_next_staff"][0];
...
if ($catalog_id == $block['iblock_id']) {
 ...
 elseif ($staff_id == $block['iblock_id']){
    include __DIR__ . '/iblock_sections__aspro-staff.php';
} 
else {
