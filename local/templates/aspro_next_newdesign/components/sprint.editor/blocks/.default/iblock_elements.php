...
$licenses_id = CNextCache::$arIBlocks[SITE_ID]["aspro_next_content"]["aspro_next_licenses"][0];
$vacancy_id = CNextCache::$arIBlocks[SITE_ID]["aspro_next_content"]["aspro_next_vacancy"][0];
...
} elseif ($licenses_id == $block['iblock_id']){
    include __DIR__ . '/iblock_elements__aspro-licenses.php';
} 
  elseif ($projects_id == $block['iblock_id']){
    include __DIR__ . '/iblock_elements__aspro-projects.php';
} 
  elseif ($vacancy_id == $block['iblock_id']){
    include __DIR__ . '/iblock_elements__aspro-vacancy.php';
} 
else {
