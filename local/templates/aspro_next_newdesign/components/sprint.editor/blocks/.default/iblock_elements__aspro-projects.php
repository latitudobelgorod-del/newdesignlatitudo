...
//$myparam1 = !empty($settings['param1']) ? $settings['param1'] : '';
?>

<?if ($block['settings']['param1'] == 'style1') : //выводим текст блока  в каком-либо оформлении ?>
    <div class="text-block-style1">
      	
<? $APPLICATION->IncludeComponent(
    "bitrix:news.list",
    "news-project-service-editor",
    array(
...
<? else: //выводим текст блока без какого-либо оформления?>
