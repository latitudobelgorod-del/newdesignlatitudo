...
<div  class="sect_button animate-load white btn-default btn">Смотреть фото и цены</div></div>
	...
	<div class="col-md-offset-4  col-md-4 col-sm-4 col-xs-12 col">
		<div class="col-item" >
				<div class="item" >
					<div class="img shine">
						<!--noindex--><a class="thumb" href="https://latitudo.org" rel="nofollow"><img class="lazy" src="/assets/lazyload/loading.gif" data-original="/images/fasad.jpg" alt="Перейти на отдельный сайт по фасадным материалам" title="Перейти на отдельный сайт по фасадным материалам"></a><!--/noindex-->
											</div>

					<div class="name">
					<div class=" col-md-12 col-sm-12"><!--noindex--><a  class="white_link" href="https://latitudo.org" rel="nofollow">Отдельный сайт по фасадным материалам</a><!--/noindex--></div>
					</div>				
				</div>
				<div class="per_next" ><!--noindex--><a  class="white btn-default btn" href="https://latitudo.org" rel="nofollow">Перейти</a><!--/noindex--></div>
