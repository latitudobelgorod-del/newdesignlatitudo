 ...
 *
 * Галочка BUTTON_VIDEO ставит под плашкой с зарплатой встроенное видео-
 * презентацию вакансии с Rutube (Ирина, 14 сентября 2026; до этого была
 * кнопка рядом с «Отправить резюме», открывавшая ролик во всплывающем окне).
 * Ролик один на все такие вакансии, поэтому адрес задан здесь, а не свойством.
 */
							...
							<div class="nd-vac__acc-body">
								<div class="nd-vac__acc-inner">
									...
									<?// Флажок — список с одним значением «да»: отмечен, если
									  // значение вообще есть. Адрес ролика лежит в data-src:
									  // плеер грузится, только когда вакансию раскрыли, и
									  // сбрасывается при сворачивании, чтобы звук не играл
									  // из закрытого пункта (js/newdesign-vacancies.js).?>
									<?if(!empty($arItem['PROPERTIES']['BUTTON_VIDEO']['VALUE'])):?>
										<div class="nd-vac__video">
											<iframe data-nd-vac-video data-src="<?=htmlspecialcharsbx($sNdVacVideoSrc)?>"
												title="Видео-презентация вакансии «<?=$arItem['NAME']?>»"
