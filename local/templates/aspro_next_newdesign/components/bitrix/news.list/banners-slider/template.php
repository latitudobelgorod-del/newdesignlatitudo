...
?>
<div class="swiper slider-solution banners-slider slider-in-section outer-rounded-x hidden" data-plugin-options='<?=\Bitrix\Main\Web\Json::encode($gallerySetting);?>'>
