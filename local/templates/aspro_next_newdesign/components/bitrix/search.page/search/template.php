...
<div class="search-page-wrap 1">
	...
	<?elseif(count($arResult["SEARCH"])>0):?>
		<div class="saerch_result">Результаты поиска по запросу: <strong><?=$arResult["REQUEST"]["TAGS"]?></strong></div>
    	<div class="row banners-small blog">
    	    <div class="items">
		...
		<?foreach($arResult["SEARCH"] as $arItem):?>
			...
			<!--<a href="-->
			<?/*=$arItem["URL"]?>"><?=$arItem["TITLE_FORMATED"]?></a>
			<?if($arItem["CHAIN_PATH"]):?>
				<ul class="path">
				    <?=$arItem["CHAIN_PATH"]?></ul>
			<?endif;?>
			<div class="text"><?=$arItem["BODY_FORMATED"]*/?>
			<!--</div>-->
			
			
					<div class="col-md-3 col-sm-4">
								<div class="item shadow animation-boxs">
								  <a href="<?=$arItem["URL"]?>">
									<div class="inner-item">
											<div class="image shine">
											     <?
                                                      ...
                                                      $img = CFile::ResizeImageGet($grab["PREVIEW_PICTURE"], array( "width" => 300, "height" => 180 ), BX_RESIZE_IMAGE_PROPORTIONAL,true )
                                                  ?>
                                                  <img src="<?=$img["src"]?>" class="img-responsive" />
											</div>
										<div class="title height">
										<?=$arItem["TITLE_FORMATED"]?>
											<!--<div class="prev_text-block">-->
