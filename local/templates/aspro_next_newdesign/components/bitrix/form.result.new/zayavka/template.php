...
<div class="form inline nd-zayavka <?=$arResult["arForm"]["SID"]?> <?=$rand?>">
...
<?$bShowLicenses = (isset($arParams["SHOW_LICENCE"]) ? $arParams["SHOW_LICENCE"] : COption::GetOptionString("aspro.next", "SHOW_LICENCE", "Y"));?>
			...
			<?endif;?>
			<input type="submit" class="nd-btn nd-btn--red nd-zayavka__submit" value="<?=$arResult["arForm"]["BUTTON"]?>" name="web_form_submit">
