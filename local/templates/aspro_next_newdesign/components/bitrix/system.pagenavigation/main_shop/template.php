...
<?if($arResult["NavPageCount"] > 1):?>
	...
	<?
	// показ 404 если страница введена которой нет
...
/*	// показ 404 если страница введена которой нет
    ...
    $urlPath = parse_url($arResult["sUrlPath"], PHP_URL_PATH);
    ...
    if ($newUrlPath) {
        $arResult["sUrlPath"] = str_replace($urlPath, $newUrlPath, $arResult["sUrlPath"]);
    }
...
<?}*/?>
	...
	<div class="module-pagination" de1="<?=$strNavQueryString?>" de2="<?=$strNavQueryStringFull?>">
		<div class="nums">
