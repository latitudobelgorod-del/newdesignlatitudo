                ...
                <div class="form-footer socserv1">
                    ...
                    <div class="inner-table-block">
                        <div class="more_text_small">
                            <?$APPLICATION->IncludeFile(SITE_DIR.'include/top_auth.php', [], ['MODE' => 'html', 'NAME' => GetMessage('TOP_AUTH_REGISTER')]);?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            function initValidate($form) {
                if ($form.length) {
                        ...
                        submitHandler: function(form) {
                            ...
                            if ($form.valid()) {
                                (new Promise((resolve, reject) => {
                                    ...
                                    if (result) {
                                        const $button = $form.find("input[type=submit]:visible");
                                        if ($button.length) {
                    ...
                    if (arNextOptions['THEME']['PHONE_MASK'].length) {
                        ...
                        showPhoneMask(inputPhoneSelector);
                        $form.find(inputPhoneSelector).blur(function() {
