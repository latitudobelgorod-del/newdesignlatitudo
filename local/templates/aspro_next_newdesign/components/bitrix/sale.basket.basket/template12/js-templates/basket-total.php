				...
				<div class="basket-checkout-block basket-checkout-block-total">
					<div class="basket-checkout-block-total-inner">
						...
						<div class="basket-checkout-block-total-description">
                            ...
                            {{#VOLUME_FORMATED}}
                            <br>
                            <?=Loc::getMessage('SBB_VOLUME')?>: {{{VOLUME_FORMATED}}}
                            {{/VOLUME_FORMATED}}
						...
						<div class="basket-checkout-block-total-description">* Расчет справочный<br/>(без учета упаковки, поддонов и мелких деталей)</div>
					</div>
				</div>
