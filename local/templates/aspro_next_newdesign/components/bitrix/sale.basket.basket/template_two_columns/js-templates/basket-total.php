...
<div style="font-size: 12px;padding: 25px 7px;">
...
<div class="basket-checkout-section-inner">
		...
		<div style="border:1px solid #e2dfdf;padding: 25px;width:100%;">
		<div class="basket-checkout-section top hidden-xs" >				
				<div class="basket-checkout-block basket-checkout-block-total">
					<div class="basket-checkout-block-total-inner">
		...
		<div style=" overflow: auto;width:100%; padding-top:25px;">
...
<div class="block_total_bottom" style="padding:25px 7px;">					
