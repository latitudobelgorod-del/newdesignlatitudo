...
<script id="basket-item-template" type="text/html">
	<tr class="basket-items-list-item-container{{#SHOW_RESTORE}} basket-items-list-item-container-expend{{/SHOW_RESTORE}}"
									...
									switch (trim((string)$blockName))
									{
										case 'props':
											if (in_array('PROPS', $arParams['COLUMNS_LIST']))
											{
												?>
												{{#PROPS}}
													<div class="basket-item-property<?=(!isset($mobileColumns['PROPS']) ? ' ' : '')?>">
										...
										case 'columns':
											...
											{{#COLUMN_LIST}}
													...
													<div class="basket-item-property-custom basket-item-property-custom-text
														...
														data-entity="basket-item-property">
														<div class="basket-item-property-custom-name">{{NAME}}:
		...
		{{#SHOW_DISCOUNT_PRICE}}
			...
			{
				?>
				<div class="basket-items-list-item-price<?=(!isset($mobileColumns['SUM']) ? ' hidden-xs' : '')?>">
					<div class="basket-item-block-price">
						<div class="basket-item-price-current">
							<span class="basket-item-price-current-text" id="basket-item-sum-price-{{ID}}">
								...
								{{#SHOW_DISCOUNT_PRICE}}
							<div class="basket-item-price-old" style="display:inline-block;margin-left:10px;">
...
">
								...
								<div id="basket-item-sum-price-difference-{{ID}}" style="
								white-space: nowrap;display: inline-block;padding:3px 5px 2px;
								line-height:16px;border-radius:3px;margin:1px 0px 1px 3px;color: #1d2029;">
