...
<script id="basket-item-template" type="text/html">
	<tr class="basket-items-list-item-container{{#SHOW_RESTORE}} basket-items-list-item-container-expend{{/SHOW_RESTORE}}"
		...
		{{^SHOW_RESTORE}}
			...
			{
				?>
					<td class="basket-items-list-item-price basket-items-list-item-price-for-one<?=(!isset($mobileColumns['PRICE']) ? ' hidden-xs hidden-sm' : '')?>">
		...
		{{#SHOW_DISCOUNT_PRICE}}
							<div class="basket-item-price-old 1">
		...
		{{/SHOW_DISCOUNT_PRICE}}
			...
			if ($useSumColumn)
			{
				...
				<td class="basket-items-list-item-price<?=(!isset($mobileColumns['SUM']) ? ' hidden-xs' : '')?>">
					<div class="basket-item-block-price main">
...
<div class="differ-per <?=$discountPositionClass?>">
