...
/* Чипы делят ширину колонки поровну (просьба Ирины, 2026-08-10). В макете они
   шириной по содержимому, но там пять городов и ряд заполнен целиком, а у нас
   их четыре — справа оставалась пустота. min-width:0 нужен, чтобы длинное
   название («Ростов-на-Дону») не растягивало свою ячейку за счёт остальных. */
.store-item {
