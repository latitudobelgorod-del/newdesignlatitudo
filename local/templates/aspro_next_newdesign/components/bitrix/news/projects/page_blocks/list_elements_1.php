...
<?$APPLICATION->IncludeComponent("bitrix:menu", "menu_line", Array(
...
$arSubSections = CNextCache::CIblockSection_GetList(array("CACHE" => array("TAG" => CNextCache::GetIBlockCacheTag($arParams["IBLOCK_ID"]), "MULTI" => "Y")), $arSubSectionFilter, false, array("ID", "DEPTH_LEVEL", "NAME"));?>
					<?if($arSubSections):?>
						<?// sections list?>
