...
$objDateTimeSale = new DateTime();
$time_nowSale = $objDateTimeSale->getTimestamp();
$GLOBALS['arrFilterSALE'] = Array(">DATE_ACTIVE_TO" => $time_nowSale, "PROPERTY_LINK_REGION" => $regionID, "ACTIVE" => "Y", "ACTIVE_DATE" => "Y");
*/?>
