...
<?
/**
 * Список акций нового дизайна. Копия асprovского list_elements_6, отличается
 * только шаблоном карточек: `akciya_newdesign` вместо `akciya_two`.
 */
?>
 <?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		// навигация общая с портфолио и отзывами, а не асprовская `.default`
