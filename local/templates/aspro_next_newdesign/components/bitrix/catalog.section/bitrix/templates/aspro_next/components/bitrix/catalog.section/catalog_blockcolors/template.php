...
$renderImg = CFile::ResizeImageGet($arItem['PREVIEW_PICTURE'], Array("width" => 100, "height" => 100), BX_RESIZE_IMAGE_PROPORTIONAL, false);
					...
					<?endif;?>
										<img class="lazy" data-src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>"  alt="<?=$a_alt;?>" title="<?=$a_title;?>" />
									...
									<?elseif( !empty($arItem["DETAIL_PICTURE"])):?>
										...
										<img  class="lazy" data-src="<?=$img["src"]?>" alt="<?=$a_alt;?>" title="<?=$a_title;?>" />
									<?else:?>
										<img class="lazy" data-src="<?=SITE_TEMPLATE_PATH?>/images/no_photo_medium.png" alt="<?=$a_alt;?>" title="<?=$a_title;?>" />
									<?endif;?>
	...
	<div class="article_block" style="color: #d0d0d0;font-size: 8px;position: absolute;top: 0;right: 5px;" class="item-article">
