...
$renderImg = CFile::ResizeImageGet($arItem['PREVIEW_PICTURE'], Array("width" => 100, "height" => 100), BX_RESIZE_IMAGE_PROPORTIONAL, false);
				...
				<?if($arItem["OFFERS"]):?>
								<?if(!empty($arItem['OFFERS_PROP'])):?>
	<div style="color: #d0d0d0;font-size: 8px;position: absolute;top: 0;right: 5px;" class="item-article"></div>
			<?endif;?>
			<?else:?>
			<?if ($isArticle): ?>
							<div style="color: #d0d0d0;font-size: 8px;position: absolute;top: 0;right: 5px;"><?=$isArticle?>	</div>
