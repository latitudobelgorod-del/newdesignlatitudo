...
$(document).ready(function(){
	setTimeout(function(){
		...
		$('.catalog_block .catalog_item_wrapp .catalog_item .item-article').sliceHeight();
	...
	if(typeof eventdata !== 'undefined' && typeof eventdata !== 'string'  && eventdata !== null)
	{
		if('action' in eventdata && eventdata.action == 'ajaxContentLoadedTab')
		{
			setTimeout(function(){
				...
				$('.catalog_block .catalog_item_wrapp .catalog_item .item-article').sliceHeight({resize: false});
...
window.JCCatalogSection.prototype.ChangeInfo = function(type)
{
	...
	if (-1 < index){
		...
		$(this.obProduct).find('.item-article').html(this.offers[this.offerNum]['ID']); 
