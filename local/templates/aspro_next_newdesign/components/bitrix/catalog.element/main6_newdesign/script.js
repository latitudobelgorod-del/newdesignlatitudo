...
//CUSTOM START
   ...
   //CUSTOM END
	...
	// Генерируем событие для обновления остатков
...
window.JCCatalogElement.prototype.ChangeInfo = function()
{
	...
	if (-1 < index)
	{
		...
		var obj=this.offers[index],
			th=$(this.obProduct),
			_th = this;
		// console.log(obj, 'obj_selectOff');
		if(this.obProduct.querySelector('.rut-video')){
			if(obj.PROD_VIDEO){
				this.obProduct.querySelector('.rut-video').classList.add('active');
				this.obProduct.querySelector('.rut-video a').href = obj.PROD_VIDEO;
			}else{
				this.obProduct.querySelector('.rut-video').classList.remove('active');
			}
		}
