...
<section class="nd-cover">
	<div class="nd-cover__card">
		<?/* Фото обложки с 25.09.2026 — терраса с плетёной мебелью и гамаком
		     (исходник 3524×1267, ужат до 1600 — 227 КБ). Прежние лежат рядом:
		...
		<img class="nd-cover__img"
		     src="<?=SITE_TEMPLATE_PATH?>/images/newdesign/cover_main_2026.webp"
		     alt="Терраса с настилом, ограждениями и фасадом из ДПК Латитудо" width="1600" height="575">
