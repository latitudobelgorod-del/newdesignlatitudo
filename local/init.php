 ...
 *
 * Событие модуля yandex.market: узел <offer> уже собран, дописываем в него
 * (сам модуль выводит только теги из настроек прайс-листа). Касается только
 * прайс-листов «Полный товарный фид…» и «Фид бренд …» — дилерские и «для
 * вебмастера» не трогает. Выгрузку модуль гоняет агентами из cron, на
 * обычных хитах обработчик не срабатывает — файл подключаем лениво.
 *
 * Цену не трогаем: она идёт за штуку, как в каталоге. Обработчик
 * onExportOfferExtendData, который домножал её на множитель основной
 * единицы, снят 16 сентября 2026 — Яндекс Товары читают со страницы именно
 * цену за штуку и считали расхождением цену за м² в фиде.
 *
